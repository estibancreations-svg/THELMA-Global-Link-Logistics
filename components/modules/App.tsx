...
import MainHub from './MainHub.tsx';
import FleetDashboard from './FleetDashboard.tsx';
import AviationDashboard from './AviationDashboard.tsx';
import ITControlCenter from './ITControlCenter.tsx';
import AquaticDashboard from './AquaticDashboard.tsx';
import OrbitalDashboard from './OrbitalDashboard.tsx';
import OmniDashboard from './OmniDashboard.tsx'; 
import EmergencyDashboard from './EmergencyDashboard.tsx';
import HRTrainingHub from './HRTrainingHub.tsx';
import HRAdmin from './HRAdmin.tsx';
import IntegrationsBuffer from './IntegrationsBuffer.tsx';
import GovernanceHub from './GovernanceHub.tsx';
import NetZeroHub from './NetZeroHub.tsx';
import AdaptationLayer from './AdaptationLayer.tsx';
...
import UnitSetupWizard from '../UnitSetupWizard.tsx';
import QuantumEdgeCenter from './QuantumEdgeCenter.tsx';
...
import MobileFieldApp from './MobileFieldApp.tsx';
import SystemCore from './SystemCore.tsx'; // New
import TimeController from '../TimeController.tsx';
import { TacticalErrorBoundary } from '../ErrorBoundary.tsx';
import { ModuleType, User, UserRole, SystemMode, AlertLevel, SystemAlert, RULES_OF_ENGAGEMENT } from '../../types.ts';
import { Bell, Cpu, ShieldCheck, Activity, Check, Zap, Github, X, Terminal, Menu, Moon, Sun, RefreshCw, Power, Search, ChevronRight, Hash, Truck, DollarSign, GraduationCap, Users, Clock, Fingerprint, Lock, ShieldAlert, Key, CheckCircle, Smartphone, AlertTriangle, Trash2 } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const verifyLogin = () => {
      ...
      setTimeout(() => {
          ...
          setTimeout(() => {
              ...
              if (!hasGreeted) {
                  setHasGreeted(true);
                  const greeting = `Sovereign Matrix Handshake Successful. Welcome home, Architect Henry. Guardian Co-Pilot is active.`;
                  vocalize(greeting);
              }
          }, 1000);
      }, 1200);
  ...
  const dismissLog = (e: React.MouseEvent, id: string) => {
      e.stopPropagation();
      soundEngine.playClick();
